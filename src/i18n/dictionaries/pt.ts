...
const pt: Partial<Dict> = {
  ...
  "layers.intensity": "Intensidade do sismo",
  ...
  "layers.updatedNow": "Atualizado agora",
  "layers.updatedMin": "Atualizado há {n} min",
  "layers.updatedHours": "Atualizado há {n} h",

  "layers.zones": "Zonas afetadas",
  "layers.zonesHint": "Marcadas pela equipe que atende a emergência",

  "area.sev.1": "Aviso",
  "area.sev.2": "Afetada",
  "area.sev.3": "Grave",
  "area.youAreIn": "Você está dentro de {name}",
  "area.insideN": "{n} pontos dentro",
  "area.insideOne": "1 ponto dentro",
  "area.insideNeeds": "{n} pedem ajuda",
  "area.intro":
    "Marque no mapa até onde chegou. Cada zona leva seu nome e sua gravidade, e quem abrir o mapa verá se está dentro.",
  "area.empty": "Ainda não há nenhuma zona marcada.",
  "area.new": "Nova zona",
  "area.newShort": "Zona nova",
  "area.name": "Nome da zona",
  "area.nameHint": "Como as pessoas de lá a chamam.",
  "area.namePlaceholder": "Norte de Zulia",
  "area.severity": "Gravidade",
  "area.note": "O que acontece aí",
  "area.noteHint": "Uma linha. Aparece junto à zona no painel da equipe.",
  "area.draw": "Desenhar no mapa",
  "area.redraw": "Corrigir o contorno",
  "area.drawing": "Desenhando a zona",
  "area.tapToDraw": "Toque no mapa para marcar o contorno",
  "area.points": "{n} pontos",
  "area.pointOne": "1 ponto",
  "area.needPoints": "São necessários pelo menos três pontos para fechar uma zona.",
  "area.undo": "Desfazer",
  "area.done": "Pronto",
  "area.deleteConfirm": "Apagar a zona â{name}â? Deixa de aparecer no mapa.",
  "area.saveError": "Não foi possível salvar a zona.",
  "area.noRow":
    "Este site ainda serve a configuração compilada, então não há onde guardar uma zona.",
  "area.readOnly": "Marcar zonas exige o papel de administrador.",
